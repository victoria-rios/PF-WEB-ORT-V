...
/*List Ubicaciones por zona*/ 
app.get('/api/ubicaciones/:zona', async (req,res,) => {
    
    const { zona } = req.params;
    console.log(zona);
    
        Ubicacion.find({numero_zona : zona},(err, especialidades) => {
            res.json(especialidades);  
          });
...
app.post('/api/signup', async (req,res,next) => {
    ...
    const {nombre,apellido,password, tipo,dni_, especialidad } = body;
